...
export const products = [
  ...
  },
  {
    ...
    reviews: 156,
    category: "Tech",
    description: "Minimalist design smart watch"
  },
  {
    id: 4,
    ...
    reviews: 112,
    category: "Fashion",
    description: "Handcrafted leather bifold wallet"
  },
  {
    id: 5,
    ...
    reviews: 198,
    category: "Sports",
    description: "Premium eco-friendly yoga mat with non-slip grip surface"
  },
  {
    id: 6,
    ...
    reviews: 203,
    category: "Beauty",
    description: "Complete natural skincare set with organic ingredients"
  },
  {
    id: 7,
    ...
    reviews: 267,
    category: "Home",
    description: "Powerful stainless steel blender for smoothies and more"
  },
  {
    id: 8,
    ...
    reviews: 145,
    category: "Kids",
    description: "Colorful and educational puzzle set for children"
  },
  {
    id: 9,
    ...
    reviews: 98,
    category: "Sports",
    description: "Vintage retro running shoes with comfortable fit"
  },
  {
    id: 10,
    ...
    reviews: 312,
    category: "Home",
    description: "Hand-painted ceramic mug perfect for daily use"
  }
];

export const categories = [
  { id: 1, name: "Tech", icon: "devices" },
  { id: 2, name: "Fashion", icon: "checkroom" },
  { id: 3, name: "Home", icon: "chair" },
  { id: 4, name: "Beauty", icon: "face" },
  { id: 5, name: "Sports", icon: "fitness_center" },
  { id: 6, name: "Groceries", icon: "restaurant" },
  { id: 7, name: "Kids", icon: "toys" },
];
